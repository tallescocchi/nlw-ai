  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        <h1 className="text-2xl font-semibold">upload.ai</h1>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">Lembre-se: Você pode utilizar a variável <code className="text-violet-600">{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da transcrição do vídeo selecionado.</p>
        </div>
        ...
        <aside className="w-80 space-y-6">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">Valores mais altos tedem a deixar o resultado mais criativo e com possíveis erros.</span>
            </div>
            <Separator />
